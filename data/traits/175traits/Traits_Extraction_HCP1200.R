...
getwd();
#load data
#setwd('/Users/Zhengwu/Dropbox/Projects_Code&Data/Tensor_Decomposition/data')
setwd('/Users/zzheng6/Dropbox/Projects_Code_Data/Tensor_Decomposition/data')
...
writeMat('HCP_Covariates.mat',confond_variable = confond_variable, cog_measure = cog_measure,allsubject_id = allsubject_id,handness = handness);
